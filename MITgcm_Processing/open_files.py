...
iter_number = 9  # Example iteration number
...
bottom_pressure = mds.rdmds('diags/OBP_mon_mean/OBP_mon_mean', itrs=iter_number) # Ocean bottom pressure
tau_x = mds.rdmds('diags/EXFtaux_mon_mean/EXFtaux_mon_mean', itrs=iter_number) # x-axis wind stress
tau_y = mds.rdmds('diags/EXFtauy_mon_mean/EXFtauy_mon_mean', itrs=iter_number) # y-axis wind stress
heat_flux = mds.rdmds('diags/oceQnet_mon_mean/oceQnet_mon_mean', itrs=iter_number) #Diabatic heat flux
freshwater_flux = mds.rdmds('diags/oceFWflx_mon_mean/oceFWflx_mon_mean', itrs=iter_number) #Surface mass flux
