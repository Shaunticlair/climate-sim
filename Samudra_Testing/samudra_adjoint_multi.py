...
def one_timestep(initial_time, final_time):
    ...
    for in_ch_idx in range(num_in_channels):
        for out_ch_idx in range(num_out_channels):
            ...
            # Create filename that includes channel information: put in the sensitivity_arrays folder
            foldername = 'sensitivity_arrays'
            ...
            # Save to file
            np.save(Path(foldername) / filename, sensitivity_np)
