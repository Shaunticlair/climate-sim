...
def plot(t0,t1, magn, grid_size, draw_corr=False, manual_path = None):
    ...
    plt.title(f'$\\partial \\left( \\text{{2.5m }} \\theta_0 \\text{{ at }}({sensitivity_latitude},{sensitivity_longitude}), t={t1} \\right) / \\partial \\left( \\text{{2.5m }} \\theta_0 \\text{{ across map}}, t={t0} \\right)$')
...
manual_path = 'chunk_sensitivity_ch157_t9-10.npy'
